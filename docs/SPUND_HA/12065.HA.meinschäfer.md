...
### 3.1.2
o.a. daten wurden in R 1. deskriptiv und 2. mittels des paketes [lme4][3] zur erhebung kovariater abhängigkeiten (linear mixed model) analog der vorgaben RF ausgewertet. das script dazu kann hier \> [evaluation] https://github.com/esteeschwarz/essais/tree/main/docs/hux2021/evaluation ][4] nachvollzogen werden. 
